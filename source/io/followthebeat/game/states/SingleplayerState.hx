...
import io.followthebeat.game.controls.GamePlayerController;
import io.followthebeat.game.map.GameMapSegment;
import io.followthebeat.game.map.IContinuousGameMap;
import io.followthebeat.game.objects.GamePlayer;
import io.followthebeat.game.rhythm.IGameConductor;
import io.followthebeat.game.rhythm.IGameConductor;

class SingleplayerState extends FlxState implements IContinuousGameMap implements IGameConductor {
