...
@:sound("/home/mwaldrich/haxelib/flixel/4,3,0/assets/sounds/beep.ogg") @:keep #if display private #end class __ASSET__flixel_sounds_beep_ogg extends flash.media.Sound {}
@:sound("/home/mwaldrich/haxelib/flixel/4,3,0/assets/sounds/flixel.ogg") @:keep #if display private #end class __ASSET__flixel_sounds_flixel_ogg extends flash.media.Sound {}
@:font("/home/mwaldrich/haxelib/flixel/4,3,0/assets/fonts/nokiafc22.ttf") @:keep #if display private #end class __ASSET__flixel_fonts_nokiafc22_ttf extends flash.text.Font {}
@:font("/home/mwaldrich/haxelib/flixel/4,3,0/assets/fonts/monsterrat.ttf") @:keep #if display private #end class __ASSET__flixel_fonts_monsterrat_ttf extends flash.text.Font {}
@:bitmap("/home/mwaldrich/haxelib/flixel/4,3,0/assets/images/ui/button.png") @:keep #if display private #end class __ASSET__flixel_images_ui_button_png extends flash.display.BitmapData {}
@:bitmap("/home/mwaldrich/haxelib/flixel/4,3,0/assets/images/logo/default.png") @:keep #if display private #end class __ASSET__flixel_images_logo_default_png extends flash.display.BitmapData {}



@:keep class __ASSET__assets_data_eightbitwonder_ttf extends openfl.text.Font { public function new () { super (); __fontPath = "assets/data/EIGHTBITWONDER.ttf"; fontName = "8BIT WONDER Nominal"; }}


#else


class __ASSET__assets_data_eightbitwonder_ttf extends openfl.text.Font { public function new () { super (); __fontPath = "assets/data/EIGHTBITWONDER.ttf"; fontName = "8BIT WONDER Nominal";  }}
...
@:keep #if display private #end class __ASSET__assets_data_eightbitwonder_ttf extends lime.text.Font { public function new () { __fontPath = #if ios "assets/" + #end "assets/data/EIGHTBITWONDER.ttf"; name = "8BIT WONDER Nominal"; super (); }}


#if (windows || mac || linux || cpp)


@:file("/home/mwaldrich/haxelib/flixel/4,3,0/assets/sounds/beep.ogg") #if display private #end class __ASSET__flixel_sounds_beep_ogg extends lime.utils.ByteArray {}
@:file("/home/mwaldrich/haxelib/flixel/4,3,0/assets/sounds/flixel.ogg") #if display private #end class __ASSET__flixel_sounds_flixel_ogg extends lime.utils.ByteArray {}
...
@:font("/home/mwaldrich/haxelib/flixel/4,3,0/assets/fonts/monsterrat.ttf") #if display private #end class __ASSET__flixel_fonts_monsterrat_ttf extends lime.text.Font {}
@:image("/home/mwaldrich/haxelib/flixel/4,3,0/assets/images/ui/button.png") #if display private #end class __ASSET__flixel_images_ui_button_png extends lime.graphics.Image {}
@:image("/home/mwaldrich/haxelib/flixel/4,3,0/assets/images/logo/default.png") #if display private #end class __ASSET__flixel_images_logo_default_png extends lime.graphics.Image {}
...
#if (openfl && !flash)
@:keep #if display private #end class __ASSET__OPENFL__assets_data_eightbitwonder_ttf extends openfl.text.Font { public function new () { __fontPath = #if ios "assets/" + #end "assets/data/EIGHTBITWONDER.ttf"; name = "8BIT WONDER Nominal"; super (); }}
